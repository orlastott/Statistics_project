...
data {
 ...
 array [n] int index; //which results belong to which runner in the sequence 
...
parameters {
  vector<lower = 0, upper = 1> [N] endurance; //vector of endurance parameters
  vector<lower = 0> [N] speed; //vector of speed for each runner 
